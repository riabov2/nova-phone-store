...
const routes = ["app/page.tsx", "app/phones/page.tsx", "app/product/iphone-17/page.tsx", "app/cart/page.tsx", "app/checkout/page.tsx"];
...
const requiredProductValues = ["iPhone 17 Pro Max", "deep-blue", "cosmic-orange", "silver", "256 GB", "512 GB", "1 TB", "2 TB", "1469", "2469"];
const requiredLayers = ["frontGlass", "displayLayer", "frameLayer", "batteryLayer", "logicLayer", "cameraLayer", "rearLayer"];
